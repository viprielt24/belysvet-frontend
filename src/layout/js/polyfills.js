...
window.Element && function(ElProto) {
  // nextSiblingSearch
  ElProto.next = ElProto.next ||
  function(selector){
    var node = this;
...
// play() promise polyfill
+function(){
  var vid = document.createElement('video');
  if (typeof vid.play !== "object") {
    var fn = vid.__proto__.__proto__.play;
    vid.__proto__.__proto__.play = function (){
      fn.call(this);
      var _this = this;
      ...
      return new Promise( function( resolve, reject ) {
        var listenerFn = function(){
          resolve();
          _this.removeEventListener('play', listenerFn );

          vid = null;
          fn = null;
          _this = null;
        }
        _this.addEventListener( 'play', listenerFn);
      });
