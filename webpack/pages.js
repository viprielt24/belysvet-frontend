...
const pages = {
  ...
  // -----------------------------------------------------
    // ЛК Покупалель Юлицо -- ul -- юридическое лицо
    // ЛК Покупалель ФЛ -- fl -- физическое лицо
    // ЛК Дистрибьютор МП -- dismp -- дистрибьютор менеджер по продаже
    // ЛК Дистрибьютор ОтвПр -- disop -- дистрибьютор ответственный представитель
    // ЛК Проектировщик -- proektir -- проектировщик
  // -----------------------------------------------------
  'user-homepage-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя'],
    }
  },
  'user-homepage': {
    parameters: {
  ...
  'user-homepage-disop-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет дистрибьютора'],
    }
  },
  'user-homepage-disop': {
    parameters: {
  ...
  'user-announce': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя', 'Коммуникации'],
  ...
  'user-docs': {
    parameters: {
      ...
      title: 'Документы',
      pageName: 'Документы',
      crumbs: ['Главная', 'Личный кабинет покупателя', 'Документы'],
  ...
  'user-objects-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя', 'Объекты'],
  ...
  'user-objects-item-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя', 'Объекты', 'Торговый центр «Дружба»'],
      files: data.productsFiles,
      projectsSolution: data.solutions,
  ...
  'user-specification-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя', 'Спецификации'],
      pageDescr: '<p>Какой-то вводный текст про раздел, про объекты, для чего они и как ими пользоваться. Какой-то вводный текст про раздел, про объекты, для чего они и как ими пользоваться.Какой-то вводный текст про раздел, про объекты, для чего они и как ими пользоваться.Какой-то вводный текст про раздел, про объекты, для чего они и как ими пользоваться.</p>',
      projectsSolution: data.solutions,
      objectSelect: data.objectSelect,
    }
  ...
  'user-order-history-empty': {
    parameters: {
      ...
      crumbs: ['Главная', 'Личный кабинет покупателя', 'История заказов'],
